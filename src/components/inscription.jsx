      ...
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          <form className="max-w-lg w-full mx-auto" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="text-white text-xs block mb-2" htmlFor="name">Full Name</label>
            ...
            <div className="mt-8">
              <label className="text-white text-xs block mb-2" htmlFor="email">Email</label>
              <div className="relative flex items-center">
                <input
                  name="email"
                  type="text"
            ...
            <div className="mt-8">
              <label className="text-white text-xs block mb-2" htmlFor="password">Password</label>
              <div className="relative flex items-center">
                <input
                  name="password"
                  type="password"
            ...
            <div className="flex items-center mt-8">
              ...
              <label htmlFor="remember-me" className="text-white ml-3 block text-sm">
                ...
                <a
                  ...
                  onClick={(e) => e.preventDefault()} // Cette ligne empêche le comportement par défaut du lien
                >
            ...
            <div className="mt-8">
              ...
              <p className="text-sm text-white mt-8">
                ...
                <a href="/login" className="text-yellow-400 font-semibold hover:underline ml-1">
                  Login here
                </a>
              </p>
            </div>
